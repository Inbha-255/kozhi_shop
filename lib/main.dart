  ...
  runApp(
    DevicePreview(
      ...
      builder: (context) => MaterialApp(
        ...
        useInheritedMediaQuery: true, // This is no longer needed.
        home: Homescreen(),
...
class _HomescreenState extends State<Homescreen> {
  Color scaffoldColor = Colors.purple.shade900;
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            const Color.fromARGB(255, 105, 9, 165), // Violet
            const Color.fromARGB(255, 141, 17, 17), // Dark Purple
          ],
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: Colors.white.withAlpha(
                  51), // Approximation for 20% opacity (255 * 0.2) // Glassy effect
              border: Border.all(
                color: Colors.white.withAlpha(
                    128), // Approximation for 50% opacity (255 * 0.5)// Border to enhance the glass effect
                width: 2,
              ),
            ),
            child: ClipOval(
